...
export const principles: readonly Principle[] = [
  ...
  {
    id: "immigration-and-integration",
    number: 5,
  ...
  },
  {
    ...
    number: 6,
    title: "Europe",
    statement: "A civilizational community of sovereign nations, cooperating where cooperation serves them.",
    summary: "Unity without uniformity; subsidiarity as the governing rule.",
    manifesto: "europe",
    image: images.arcadeWide,
    body: [
      {
        type: "paragraph",
  ...
  },
  {
    ...
    statement: "Enterprise is legitimate; economic institutions remain subordinate to the common good.",
    summary: "Neither unrestricted capitalism nor centralized socialism.",
    manifesto: "economic-order",
    body: [
      {
        type: "paragraph",
  ...
  },
  {
    ...
    number: 11,
    title: "Environment",
    statement: "Land, water and living systems are inheritances to cultivate, protect and transmit.",
    summary: "Christian stewardship rather than either extraction or misanthropy.",
    manifesto: "stewardship",
