...
export const policyText: PolicyText = {
  ...
  entries: {
    ...
    "deportation-of-criminal-offenders": {
      ...
      shortAnswer: "A non-citizen convicted of a qualifying serious criminal offence should ordinarily lose the right to remain and receive a permanent re-entry ban.",
      position: [
    ...
    naturalization: {
      ...
      shortAnswer: "The normal route requires around fifteen years of lawful residence before an application may be made, with demanding assimilation requirements.",
      position: [
      ...
      implementationNote: "Ordinary residence requirements across Europe currently run to between five and ten years, so this would lengthen rather than adjust existing practice.",
      keywords: [
        "naturalization",
        "residence",
        "assimilation",
