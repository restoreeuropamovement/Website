...
export const policyText: PolicyText = {
  ...
  entry: {
    ...
    implementationHeading: "Implementation note",
  ...
  entries: {
    "catholic-confessional-state": {
      ...
      implementationNote: "Formal establishment of a confessional order would require constitutional change in most European states, and is stated here as the order Restore Europa seeks rather than as a description of current law.",
      keywords: [
        "Catholic state",
        "confessional state",
        "integralism",
    ...
    "blasphemy-and-sacrilege": {
      ...
      implementationNote: "Several European states have repealed blasphemy provisions in recent decades, so this would mean reinstating a narrower offence rather than retaining an existing one.",
      keywords: [
        "blasphemy",
        "sacrilege",
        "atheism",
    ...
    "welfare-and-social-assistance": {
      ...
      implementationNote: "Eligibility here turns on citizenship and contribution record, not on ethnicity. Restricting benefits by nationality would also engage equal-treatment rules for lawfully resident workers in several European systems.",
      keywords: [
        "welfare",
        "benefits",
        "social assistance",
    ...
    "asylum-and-international-protection": {
      ...
      implementationNote: "The policy depends on individualized protection screening and the non-refoulement principle. Existing European and international obligations would constrain any attempt to remove a person to a place where they face persecution, torture or comparable serious harm.",
      keywords: [
        "asylum",
        "refugees",
        "first safe country",
    ...
    "deportation-of-criminal-offenders": {
      ...
      implementationNote: "A lawfully resident foreign national currently benefits from procedural safeguards against expulsion under European human-rights law. Removal may also be barred where return would expose the person to prohibited ill-treatment. The intended model is therefore rapid after final conviction, but still legally reviewable where binding obligations require it. Under current EU Return Directive Article 11, entry bans are ordinarily not to exceed five years, but may exceed five years where the person represents a serious threat to public policy, public security or national security. A default ten-year ban for ordinary illegal entry would therefore go beyond the current EU rule.",
      keywords: [
        "deportation",
    ...
    naturalization: {
      ...
      implementationNote: "Ordinary residence requirements across Europe currently run to between five and ten years, so this would lengthen rather than adjust existing practice. The manifesto already states that naturalization should require meaningful knowledge of language, history and institutions, respect for the constitutional order and genuine attachment to the country. This entry consolidates those requirements as the movement's assimilation standard.",
      keywords: [
        "naturalization",
        "assimilation",
        "residence",
    ...
    "citizenship-by-descent": {
      ...
      implementationNote: "Descent here means documented citizenship or national lineage. It does not create separate civil rights by broad racial or ethnic classification.",
      keywords: [
        "descent",
        "ancestry",
        "restoration",
    ...
    "voting-rights-after-naturalization": {
      ...
      implementationNote: "Withholding the franchise from existing citizens would require constitutional change in states where the vote attaches to citizenship itself.",
      keywords: [
        "voting rights",
        "franchise",
        "suffrage",
    ...
    "high-public-office": {
      ...
      implementationNote: "Rules based on descent, birth or ethnic origin would face major equality and non-discrimination challenges under current European and international human-rights law. Any implementation would require unusually precise legal criteria and potentially constitutional or treaty change.",
      keywords: [
        "high public office",
        "president",
        "prime minister",
    ...
    "dual-citizenship": {
      ...
      implementationNote: "Europe is understood here geographically and through the movement's own network of national wings, rather than as EU membership.",
      keywords: [
        "dual citizenship",
        "dual nationality",
        "renunciation",
    ...
    "revocation-of-naturalized-citizenship": {
      ...
      implementationNote: "International and European law place substantial restrictions on rendering a person stateless, and removal normally requires a receiving state legally able and willing to admit the person. This belongs to the constitutional order Restore Europa seeks, and would require treaty or constitutional change.",
      keywords: [
        "revocation",
        "deprivation",
        "statelessness",
    ...
    "remigration-general-principle": {
      ...
      implementationNote: "Current European law imposes substantial procedural and human-rights constraints on return and expulsion. This entry states the proposed policy architecture; implementation would require conformity with, amendment of or withdrawal from incompatible legal commitments. The movement's existing manifesto already treats citizenship as membership rather than mere residence and supports controlled immigration compatible with integration, stability and national continuity.",
      keywords: [
        "remigration",
        "return",
    ...
    "integration-general-definition": {
      ...
      implementationNote: "Current EU long-term-residence law permits member states to impose integration conditions and requires stable and regular resources for acquisition of long-term status. The policy separates ancestry-based concepts of historical nationhood from the administrable legal test of whether a particular resident is integrated.",
      keywords: [
        "integration",
        "language",
        "civic knowledge",
    ...
    "regularized-irregular-immigration": {
      ...
      implementationNote: "This is a proposed retroactive review power and goes beyond the stability normally attached to final administrative decisions. It would require clear constitutional authorization, defined limitation rules and procedural safeguards.",
      keywords: [
        "regularization",
        "amnesty",
        "illegal entry",
    ...
    "employment-and-self-sufficiency-of-foreign-residents": {
      ...
      implementationNote: "Current EU long-term-residence rules require stable and regular resources to acquire long-term status, but current law also gives long-term residents significant protections and does not permit expulsion solely on economic grounds. The movement's proposed framework would go further for categories of non-citizen residence.",
      keywords: [
        "self-sufficiency",
        "employment",
        "welfare",
    ...
    "probationary-naturalization": {
      ...
      implementationNote: "This is a proposed constitutional departure from systems that treat naturalization as immediately indistinguishable from citizenship by birth for all deprivation purposes. Existing international nationality instruments constrain deprivation, especially where it would create statelessness; those conflicts would require explicit constitutional and treaty treatment.",
      keywords: [
    ...
    "residence-permit-withdrawal": {
      ...
      implementationNote: "Current EU law provides stronger protections to long-term residents. The current long-term-residence directive allows loss of status after specified absences and permits expulsion only for an actual and sufficiently serious public-order or security threat; economic considerations alone may not justify expulsion. The proposed movement policy would therefore require changes where it is broader than existing EU rules.",
      keywords: [
        "residence permit",
        "withdrawal",
        "fraud",
    ...
    "voluntary-return-and-reintegration": {
      ...
      implementationNote: "This entry is an implementation mechanism rather than a moral judgment about the person returning. Its purpose is to make return faster, cheaper and more orderly where cooperation is possible.",
      keywords: [
        "voluntary return",
        "reintegration",
    ...
    "return-readmission-identity-and-removal-procedure": {
      ...
      implementationNote: "Current EU return law limits detention to the shortest appropriate period while removal arrangements are actively pursued and contains specific maximum periods and safeguards. The proposed hybrid model adopts the general sequence of detention followed by restricted status when immediate removal is impossible, while the exact duration would depend on the legal order ultimately adopted. Birthplace is useful evidence but does not by itself establish nationality or an unconditional duty of a country to readmit a person. Readmission depends on nationality law, evidence and applicable agreements. A genuinely stateless person is someone whom no state considers a national under the operation of its law. The proposed system therefore requires nationality determination rather than assuming statelessness can always be eliminated by assigning the person to the country of birth.",
      keywords: [
        "return procedure",
        "readmission",
        "detention",
    ...
    "european-union-institutional-relationship": {
      ...
      implementationNote: "Article 5 of the Treaty on European Union already recognizes conferral, subsidiarity and proportionality. This policy would demand a materially stricter application of those principles and substantial treaty and institutional reform.",
      keywords: [
        "European Union",
        "EU",
        "sovereignty",
    ...
    "minimum-wage": {
      ...
      implementationNote: "The Catechism describes a just wage as the legitimate fruit of work and says fair pay must consider needs, contributions, productivity, the condition of the business and the common good. Laborem Exercens explicitly connects just remuneration to the ability to establish and maintain a family.",
      keywords: [
        "minimum wage",
        "just wage",
        "living wage",
    ...
    taxation: {
      ...
      implementationNote: "Catholic social teaching treats payment of taxes as part of solidarity, while requiring reasonable and fair application, integrity in public spending and special attention to families.",
      keywords: [
        "tax",
        "taxation",
        "income tax",
    ...
    pensions: {
      ...
      implementationNote: "The model applies solidarity and subsidiarity: a public floor where lower institutions cannot provide adequate security, combined with occupational institutions, household saving and private ownership.",
      keywords: [
        "pensions",
        "retirement",
        "old age",
    ...
    "housing-restrictions": {
      ...
      implementationNote: "The manifesto already states that housing should serve habitation and community rather than function principally as an appreciating financial asset. Detailed restrictions should be calibrated nationally and locally.",
      keywords: [
        "housing",
        "home ownership",
        "rent",
    ...
    "trade-unions-and-vocational-representation": {
      ...
      implementationNote: "The manifesto expressly supports modern guilds, professional chambers and vocational corporations while rejecting occupational bodies as instruments of an omnipotent state. Catholic teaching also recognizes trade-union organization and proportionate strike action.",
      keywords: [
        "trade unions",
        "guilds",
        "corporatism",
    ...
    "children-social-media-and-attention-capture": {
      ...
      implementationNote: "The manifesto expressly states that children should be protected from industries whose profit models depend on maximizing psychological dependence. The exact age-verification mechanism remains an implementation question.",
      keywords: [
        "social media",
        "children",
        "minors",
    ...
    "digital-identification": {
      ...
      implementationNote: "The manifesto explicitly protects non-digital identification where practicable and rejects unlimited technological dependence.",
      keywords: [
        "digital ID",
        "electronic identity",
        "privacy",
    ...
    "central-bank-digital-currencies": {
      ...
      implementationNote: "The manifesto does not name CBDCs, but explicitly guarantees meaningful access to physical money and rejects unnecessary technological dependency and surveillance.",
      keywords: [
        "CBDC",
        "digital euro",
        "cash",
    ...
    cryptocurrency: {
      ...
      implementationNote: "Cryptocurrency is not specifically addressed in the manifesto. This position is derived from private property, opposition to concentrated financial domination and technological subordination rather than technological prohibition.",
      keywords: [
        "cryptocurrency",
        "Bitcoin",
        "digital assets",
    ...
    "facial-recognition": {
      ...
      implementationNote: "The manifesto does not name facial recognition, but expressly protects meaningful private spaces free from permanent surveillance.",
      keywords: [
        "facial recognition",
        "biometrics",
        "CCTV",
    ...
    "communications-metadata-retention": {
      ...
      implementationNote: "Metadata retention is not named directly in the manifesto. The policy follows from its explicit rejection of permanent surveillance and technological centralization.",
      keywords: [
        "metadata",
        "data retention",
    ...
    "genetic-engineering": {
      ...
      implementationNote: "The manifesto does not settle genetic engineering in detail. The position is derived from Catholic anthropology, protection of life from conception and the principle that technological capability does not itself create moral legitimacy.",
      keywords: [
        "genetic engineering",
        "gene editing",
        "CRISPR",
    ...
    "transhumanism-and-human-enhancement": {
      ...
      implementationNote: "The manifesto's anthropology strongly constrains transhumanist projects, but detailed implementation is derived rather than explicit.",
      keywords: [
        "transhumanism",
        "human enhancement",
        "cybernetics",
    ...
    homeschooling: {
      ...
      implementationNote: "Home education is currently prohibited or tightly restricted in several European states, so this would require legislative change in those jurisdictions.",
    ...
    "state-schools-and-christianity": {
      ...
      implementationNote: "Several European states constitutionally require confessional neutrality in public education, which this position would require them to revisit.",
      keywords: [
        "state schools",
        "religious education",
        "secularism",
    ...
    "criminal-sentencing": {
      ...
      implementationNote: "The catalogue's existing prison doctrine already combines proportionate punishment, protection of society, restitution and rehabilitation.",
      keywords: [
        "criminal sentencing",
        "punishment",
        "prison",
    ...
    "death-penalty": {
      ...
      implementationNote: "This is an explicit departure from the contemporary abolitionist position of the Catholic Catechism, adopting the older traditional allowance instead. Capital punishment is also prohibited across the Council of Europe, so this would require withdrawal from or amendment of existing treaty commitments.",
      keywords: [
        "death penalty",
        "capital punishment",
        "execution",
    ...
    "capital-punishment-for-aggravated-sexual-crimes": {
      ...
      implementationNote: "This expands the catalogue's existing capital-punishment position beyond homicide-based offences. It remains an explicit departure from the contemporary abolitionist position of the Catholic Catechism. Capital punishment is prohibited across the current Council of Europe system, including under Protocol No. 13 to the ECHR for states bound by it, so implementation would require major legal and treaty change.",
      keywords: [
        "death penalty",
        "capital punishment",
        "aggravated rape",
    ...
    "energy-policy": {
      ...
      implementationNote: "The manifesto establishes environmental stewardship and strategic independence but does not specify a detailed energy mix.",
      keywords: [
        "energy security",
        "electricity",
        "reliability",
    ...
    "nuclear-energy": {
      ...
      implementationNote: "This is a derived policy judgment, not an explicit manifesto commitment. It should remain subject to technical safety, waste-management and economic review.",
      keywords: [
        "nuclear power",
        "nuclear energy",
        "reactors",
    ...
    "fossil-fuels": {
      ...
      implementationNote: "The manifesto requires stewardship but does not specify fossil-fuel phase-out dates.",
      keywords: [
        "fossil fuels",
        "coal",
        "oil",
    ...
    "renewable-energy": {
      ...
      implementationNote: "This follows the manifesto's stewardship and human-scale principles but is not explicitly specified there.",
      keywords: [
        "renewable energy",
        "solar",
        "wind",
    ...
    nato: {
      ...
      implementationNote: "NATO Article 5 treats an armed attack on one member as an attack on all and obliges each ally to assist, while leaving each ally to determine the action it deems necessary. The manifesto supports strategic independence but does not itself require withdrawal from NATO.",
      keywords: [
        "NATO",
        "Article 5",
        "collective defence",
    ...
    russia: {
      ...
      implementationNote: "This is a non-alignment doctrine, not a factual judgment on particular current disputes.",
      keywords: [
        "Russia",
        "Russian Federation",
        "Europe",
    ...
    ukraine: {
      ...
      implementationNote: "This position applies the manifesto's strong presumption against unnecessary war and preference for strategic independence.",
      keywords: [
        "Ukraine",
        "Russia",
        "war",
    ...
    "united-states": {
      ...
      implementationNote: "The policy is cooperation without dependency rather than hostility or isolation.",
      keywords: [
        "United States",
        "America",
        "strategic autonomy",
    ...
    "israel-and-palestine": {
      ...
      implementationNote: "This is non-alignment, not indifference to civilian harm or international humanitarian obligations. The arms restriction applies to every party without exception: it follows from the presumption against fuelling a conflict Europe is not party to, and is not a measure directed at one state.",
      keywords: [
        "Israel",
        "Palestine",
        "Gaza",
    ...
    "foreign-aid": {
      ...
      implementationNote: "The manifesto does not specify foreign-aid budgets or mechanisms. This is derived from prudence, humanitarian concern and the presumption against ideological intervention.",
      keywords: [
        "foreign aid",
        "humanitarian aid",
    ...
    sanctions: {
      ...
      implementationNote: "The policy applies proportionality and prudence to non-military coercion. It does not create an automatic sanctions policy toward any named state.",
      keywords: [
        "sanctions",
        "embargo",
        "asset freeze",
    ...
    conscription: {
      ...
      implementationNote: "Catholic social teaching recognizes legitimate national defence while also recognizing conscientious objection and moral limits on the conduct of armed forces.",
      keywords: [
        "conscription",
        "military service",
        "national service",
    ...
    "nuclear-weapons": {
      ...
      implementationNote: "Pope Francis has repeatedly described both the use and possession of nuclear weapons as immoral and called for disarmament. The adopted policy follows that contemporary Catholic direction.",
      keywords: [
        "nuclear weapons",
        "nuclear disarmament",
        "deterrence",
