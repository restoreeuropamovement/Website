...
export const homePrinciples: readonly HomePrinciple[] = [
  {
    number: "01",
  ...
  },
  {
    ...
    statement: "Land, architecture and nature are inheritances to cultivate, protect and transmit.",
